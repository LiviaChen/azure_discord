...
let WITAPIKEY = null; 
let TEXTANALYTICSKEY = null;
let TEXTANALYTICSENDPOINT = null;
let TRANSLATEKEY = null;
let TRANSLATEENDPOINT = null;
...
async function sentimentAnalysis(msg){
    ...
    sentimentResult.forEach(document => {
        ...
        analysisResult += `\n\tDocument Scores:`;
        analysisResult += `\n\t\tPositive: ${document.confidenceScores.positive.toFixed(2)} \tNegative: ${document.confidenceScores.negative.toFixed(2)} \tNeutral: ${document.confidenceScores.neutral.toFixed(2)}`;
...
discordClient.on('message', async (msg) => {
    try {
		...
		var subscriptionKey = TRANSLATEKEY;
		var endpoint_translate = TRANSLATEENDPOINT;
...
const speechConfig = sdk.SpeechConfig.fromSubscription("f13676adf97e41d98019878715830bb7", "southcentralus");

function fromFile(outfile, mapKey) {
